...
<div className="drawer drawer-end">
  ...
  <div className="drawer-content flex flex-col">
    {/* <!-- Navbar --> */}
    <div className="w-full navbar fixed top-0 z-50 bg-base-300 lg:px-20"> 
        ...
        <ul className="menu menu-horizontal gap-x-2">
          {/* <!-- Navbar menu content here --> */}
            ...
            <label className="swap swap-rotate">
                  ...
                  <input data-toggle-theme='dark,light' type="checkbox" data-act-class="ACTIVECLASS" />
                  {/* <!-- sun icon --> */}
    ...
    <ul className="menu p-4 w-80 bg-base-100 text-base-content">
      {/* <!-- Sidebar content here --> */}
        ...
        <li className="dropdown dropdown-hover">
            <label tabIndex={0} className="btn m-1 btn-outline rounded-lg">Hover</label>
            <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                <li><Link>Item 1</Link></li>
                <li><Link>Item 2</Link></li>
            </ul>
